...
export const MemoryGameSlice = createSlice({
  ...
  reducers: {
    setState: (state, action) => {
      state.items[action.payload - 1].isActive =
        !state.items[action.payload - 1].isActive;
      if (state.slots === 2) {
        state.firstSlot = action.payload - 1;
        state.slots = state.slots - 1;
      } else if (state.slots === 1) {
        state.secondSlot = action.payload - 1;
        state.slots = state.slots - 1;
      } else {
      ...
      console.log(state.firstSlot);
      console.log(state.secondSlot);
    },
  },
});
